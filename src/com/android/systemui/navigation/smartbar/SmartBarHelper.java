...
public class SmartBarHelper {
    ...
    public static BitmapDrawable resizeCustomButtonIcon(Drawable d, Context ctx) {
        ...
        final float scaledWidth = scale * originalWeight;
        final float scaledHeight = scale * originalHeight;
